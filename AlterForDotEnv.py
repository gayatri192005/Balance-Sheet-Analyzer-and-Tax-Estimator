...
def financial_chat(query, analysis, data):
    ...
    - Provide the calculation steps and final result in a clear format.
    
    2. For general financial questions, provide understandable explanation. If use asks "what is...", provide the explanation fo the term and calculation too.
